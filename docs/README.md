...
![Preview of a figure written in the pic language in Visual Studio Code](pikfit.svg "Preview of a figure written in the pic language in Visual Studio Code")
